...
# 🔥 NEW CLEAN MESSAGE PATCH — added exactly as requested
def clean_messages(messages):
    ...
    for m in messages:
        ...
        output.append({"role": m.type, "content": content})
    return output
...
selected_models = st.sidebar.multiselect(
    ...
    ["gemma2-27b-it", "llama3.1-70b-versatile", "qwen2.5-72b-instruct", "llama3-70b-8192"],
    default=["gemma2-27b-it"]
)
    ...
    for model_name in selected_models:
        ...
        with st.spinner(f"Thinking with {model_name}..."):
            ...
            if uploaded_files and retriever is not None:
                ...
                # 🔥 FIXED AIMessage → text extraction
                answer = response["answer"]
                if hasattr(answer, "content"):
                    answer = answer.content
                assistant_reply = re.sub(r"<think>.*?</think>", "", answer, flags=re.DOTALL).strip()
                ...
                # 🔥 NEW CLEAN MESSAGE FIX APPLIED HERE
